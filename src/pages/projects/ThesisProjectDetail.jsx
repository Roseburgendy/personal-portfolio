...
import { FaCalendarAlt, FaUsers, FaGithub } from 'react-icons/fa'
...
export const ThesisProjectDetail = () => {
  ...
  const featureSets = [
    ...
    },
    {
      ...
      visual: ['breathing-mechanics-1.mp4', 'breathing-mechanics-2.mp4'],
      isVertical: true,
      isVideo: true
    },
    {
              ...
              <RevealOnScroll key={set.title}>
                ...
                {index === 1 ? (
                  <div className='space-y-8'>
                    ...
                    {/* Two videos in grid below */}
                    <div className='grid md:grid-cols-2 gap-6'>
                      {set.visual.map((media, idx) => (
                        <div
                          key={idx}
        ...
        <section id='demo' className='py-24'>
          ...
          <div className='max-w-5xl mx-auto text-center mt-20'>
            <div className='flex flex-wrap justify-center gap-4'>
              ...
              <a
                href='https://github.com/Roseburgendy/VR_Breathing_Intervention'
                target='_blank'
                rel='noopener noreferrer'
                className='inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-lg border-2 transition-all duration-300 group'
                style={{
                  fontFamily: 'Montserrat, sans-serif',
                  borderColor: 'var(--accent-600)',
                  color: 'var(--accent-600)',
